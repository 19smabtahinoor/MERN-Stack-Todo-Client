        ...
        <section className="max-w-screen-lg mx-auto py-24 px-6">
            ...
            <div className="p-4 my-4 box-border rounded-lg border border-gray-200 flex flex-col lg:flex-row items-center space-y-3 lg:space-y-0">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <select className=" border border-gray-200 p-3 rounded-lg focus:outline-none focus:ring-4 ring-purple-300 transition duration-300" value={status} onChange={handleChange}>
                        <option value="All" className="text-lg py-6 rounded-lg">All</option>
                        <option value="Planning todo" className="text-lg py-6 rounded-lg">Planning todo</option>
